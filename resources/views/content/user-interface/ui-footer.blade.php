        ...
        <div
            ...
            <div class="d-flex flex-column flex-sm-row gap-3">
                ...
                <div class="dropdown dropup footer-link">
                    <button type="button" class="btn btn-sm btn-outline-secondary dropdown-toggle h-100"
                        data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Currency
                    </button>
                    <div class="dropdown-menu dropdown-menu-end">
                        <a class="dropdown-item" href="javascript:void(0);"><i
                                class='mdi mdi-currency-usd me-2'></i>USD</a>
                        <a class="dropdown-item" href="javascript:void(0);"><i
                                class='mdi mdi-currency-eur me-2'></i>Euro</a>
                        <a class="dropdown-item" href="javascript:void(0);"><i
                                class='mdi mdi-currency-gbp me-2'></i>Pound</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="javascript:void(0);"><i
                                class='mdi mdi-currency-btc me-2'></i>Bitcoin</a>
                    </div>
                </div>
                <a href="javascript:void(0)" class="btn btn-sm btn-outline-danger"><i
                        class='mdi mdi-logout me-1'></i>Logout</a>
            </div>
        </div>
    </footer>
</section>
