...
<div class="card">
    ...
    <h4 class="py-1 mb-1">
        ...
        <a href="{{ route('sizes.create') }}" class="btn btn-primary text-right">Add New</a>
                    ...
                    <td>
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item" href="{{ route('sizes.edit',[$rol->id]) }}"><i class="mdi mdi-pencil-outline me-1"></i> Edit</a>

                                <form action="{{ route('sizes.destroy',[$rol->id]) }}" method="POST">
