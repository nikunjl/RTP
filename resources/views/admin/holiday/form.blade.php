        ...
        <div class="card mb-4">
            <div class="card-body">
                <div class="form-floating form-floating-outline mb-4">
                    <input type="text" name="name" class="form-control" id="basic-default-holiday" placeholder="Name" value="{{ $holiday->name ?? old('name') }}" />
                ...
                <div class="form-floating form-floating-outline mb-4">
                    <input type="date" name="holiday_date" class="form-control" id="basic-default-holiday" placeholder="Name" value="{{ $holiday->holiday_date ?? old('holiday_date') }}" />
                    <label for="basic-default-fullname">Name</label>
                    @error('holiday_date')
                    <strong style="color: red;">{{ $message }}</strong>
                    @enderror
