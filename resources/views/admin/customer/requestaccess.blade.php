        ...
        <table class="datatables-basic table table-bordered">
            ...
            <tbody class="table-border-bottom-0">
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('customerAccess',array('id' => $cus->id)) }}" class="dropdown-item btn btn-primary" onclick="return confirm('Are you sure you want to access?');" class="mdi mdi-trash-can-outline me-1"><i class="mdi mdi-pencil-can-outline me-1"></i>Access</a>
                    </td>
