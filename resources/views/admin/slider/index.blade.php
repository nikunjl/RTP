...
<div class="card">
    ...
    <h4 class="py-1 mb-1">
        ...
        <a href="{{ route('sliders.create') }}" class="btn btn-primary text-right">Add New</a>
                    ...
                    <td>
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item" href="{{ route('sliders.edit',[$cat->id]) }}"><i class="mdi mdi-pencil-outline me-1"></i> Edit</a>

                                <form action="{{ route('sliders.destroy',[$cat->id]) }}" method="POST">
