...
<div class="card">
    <h4 class="py-1 mb-1">
        <a href="{{ route('user.create') }}" class="btn btn-primary text-right">Add New</a>
    </h4>
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="{{ route('user.edit',[$cat->id]) }}"><i class="mdi mdi-pencil-outline me-1"></i> Edit</a>
